...
// Mon Mar 11 22:15:50 2019 by ROOT version 6.12/07
// from TTree LamC3P/matchedLamC3P
// found on file: matchLamC3PTree_fullSample_reRECO.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("matchLamC3PTree_fullSample_reRECO.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("matchLamC3PTree_fullSample_reRECO.root");
      }
